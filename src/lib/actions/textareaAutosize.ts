...
function eventListenerStore<K extends keyof HTMLElementEventMap, T extends HTMLElement>(
	eventName: K,
	...
	function start() {
		...
		targetElement && targetElement.addEventListener(eventName, listener);
	}
...
export function textareaAutoSize(node: HTMLTextAreaElement) {
	function init() {
