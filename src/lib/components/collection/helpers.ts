...
import type { CollectionWithViews, SearchableCollection } from '$lib/types.js';

export function getCollectionView(collection: CollectionWithViews | SearchableCollection) {
