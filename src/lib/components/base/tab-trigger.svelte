...
<button
	...
	class={tm(
		'h-10 lg:h-9 flex items-center justify-center py-1.5 px-2.5 whitespace-nowrap font-semibold border-2 rounded-xl shadow-sm transition-all hover:bg-secondary/70',
