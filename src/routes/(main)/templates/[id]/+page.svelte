<script lang="ts">
	...
	import PageContent from '$lib/components/page/page-content.svelte';

	export let data: PageData;
	$: ({ template, isModal } = data);
...
<PageContainer isInsideModal={isModal} class={cn(isModal && 'h-auto w-full bg-background')}>
	{#if !isModal}
		<PageHeader />
	{/if}

	<PageContent class={cn(isModal && 'lg:p-2')}>
